					...
					<td>
						<div class="file">
						 <label class="file-label">
							<input type="file" name="picname" id="picname" class="input" accept="image/*">
						 </label>
						</div>
					</td>
				</tr>	
				<tr>
					<td>
						<div class="field is-ground">
						 <div class="control">
						 	<button type="button" class="button is-link" onclick="fileUpload()">업로드 </button>								
						 </div>
						 <div class="control">
