...
<nav class="breadcrumb" aria-label="breadcrumbs"  style="border-bottom:2px solid #ddd; padding-bottom:8px; min-height:48px; line-height:48px;">
  			<ul style="float:right;">
  				...
  				<li class="is-active"><a href="${path1 }/" aria-current="page">전체 장소 목록</a>
  				<li class="is-active"><a href="${path1 }/GetTourCateListCtrl.do?cate=${dto.cate}">
  				...
  				<li class="is-active"><a href="#" araia-current="page">${dto.palce }</a></li>
  			</ul>
  		  </nav>
  				...
  				<div id="con">
  					...
  					<div class="buttons">
  						...
  						<c:if test='${sid.equals("admin") }'>
  							...
  							<a href="${path1 }/ModifyTourCtrl.do?no=${dto.no }" class="button is-danger">장소 수정</a>	
  						</c:if>
  					</div>
  		</div>
  	</section>
